...
if upload_file is not None:
    ...
    # perform gaussianBlur
    img_blur1 = cv2.GaussianBlur(normalized_image, (5, 5), 0)

    # convert colorspace
    grayImage1 = cv2.cvtColor(img_blur1, cv2.COLOR_BGR2GRAY)
    ...
    ret, thres = cv2.threshold(grayImage1, threshold_value, 255, cv2.THRESH_BINARY)
    st.image(thres, caption='Normalizeds Image', use_column_width=True)
