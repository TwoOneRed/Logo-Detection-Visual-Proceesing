...
st.text("Top 1 = " + shops_count_sorted[0][0] + '( '+ shops_count_sorted[0][1] + ')')
st.text("Top 2 = " + shops_count_sorted[1][0] + '( '+ shops_count_sorted[1][1] + ')')
st.text("Top 3 = " + shops_count_sorted[2][0] + '( '+ shops_count_sorted[2][1] + ')')
st.text("Top 4 = " + shops_count_sorted[3][0] + '( '+ shops_count_sorted[3][1] + ')')
st.text("Top 5 = " + shops_count_sorted[4][0] + '( '+ shops_count_sorted[4][1] + ')')
